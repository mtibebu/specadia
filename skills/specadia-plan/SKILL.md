---
name: specadia-plan
description: Use the installed Specadia CLI to turn software intent or existing requirements into a reviewed system design, implementation contract, and traceability artifacts. Use when the user asks to plan, specify, or design software with Specadia.
---
