...
narration=(
  "This is Bookmark Buddy, a tiny local-first command-line app for saving and searching bookmarks. It starts from one plain-English intent."
  "Save, organize, and search bookmarks, all on your own machine. No accounts, cloud services, or hidden dependencies."
  "That intent becomes reviewed requirements: authored by a person, produced with Read Mass, or generated by Specadia with agents enabled. In this deterministic demo, the requirements are already approved inputs."
  "A reviewed design adds the architecture and file structure, making implementation choices visible before coding begins."
...
captions=(
  "This is Bookmark Buddy, a tiny local-first command-line app for saving and searching bookmarks. It starts from one plain-English intent."
  "Save, organize, and search bookmarks, all on your own machine. No accounts, cloud services, or hidden dependencies."
  "That intent becomes reviewed requirements: authored by a person, produced with READ-MAS, or generated by Specadia with agents enabled. In this deterministic demo, the requirements are already approved inputs."
  "A reviewed design adds the architecture and file structure, making implementation choices visible before coding begins."
  "Now Specadia takes over. Generate runs twice with the same inputs, without credentials or a live model, then compares both outputs."
  "The runs are byte-for-byte identical, and no local absolute paths leak into the generated artifacts."
  "The coding-agent contract maps every requirement and acceptance criterion back to its reviewed source."
