---
name: specadia-plan
description: Use the installed Specadia CLI to turn software intent or an existing SRS and design into reviewed requirements, system design, a Cursor implementation contract, and traceability artifacts. Use when the user asks to plan, specify, design, or prepare a traceable implementation contract with Specadia.
---

# Specadia Plan

Keep Specadia's Python CLI as the execution engine. Use this skill only as the Cursor-facing
workflow adapter.
...
6. Report the SRS, design, implementation contract, manifest, and traceability paths.
...
3. Run:
   ...
   ```bash
   specadia contract "<srs-path>" --design "<design-path>" --harness generic
   ```
