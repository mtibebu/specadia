---
name: specadia-plan
description: Use the installed Specadia CLI to turn software intent or existing requirements into a reviewed system design, implementation contract, and traceability artifacts. Use when the user asks Cline to plan, specify, or design software with Specadia.
---

# Specadia Plan

Use Specadia as the engine and Cline as the implementation harness.
...
5. Report all generated source, contract, manifest, and traceability paths.
